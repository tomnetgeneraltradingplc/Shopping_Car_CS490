 ...
 */
package edu.mum.cs490.shoppingcart.mock.transaction.api.aop;
...
import edu.mum.cs490.shoppingcart.mock.transaction.api.util.AES;
...
public class TransactionAOPService {
     ...
     * @throws Throwable
     */
    @Around("execution(* edu.mum.cs490.shoppingcart.mock.transaction.api.service.*.*(..))&& args(requestStr)")
...
//    @Around("execution(* edu.mum.cs490.shoppingcart.mock.transaction.api.dao.AccountDAO.findByCardNoAndNameAndZipCodeAndCVVAndExpirationDateAndCardType(..))&& args(cardNo, name, zipCode, CVV, expirationDate, cardType)")
...
//    @Around("execution(* edu.mum.cs490.shoppingcart.mock.transaction.api.dao.AccountDAO.findByCardNo(..))&& args(cardNo)")
    ...
    //@Around("execution(* edu.mum.cs490.shoppingcart.mock.transaction.api.dao.AccountDAO.save(..))&& args(account)")
...
//    @Around("execution(* edu.mum.cs490.shoppingcart.mock.transaction.api.service.TransactionService.refreshAccount(..))&& args(account)")
...
//    }
    ...
    // TransactionDAO
    //edu.mum.cs490.shoppingcart.mock.transaction.api.dao.TransactionDAO.getLastActiveTransaction(String srcCardNo)
//    @Around("execution(* edu.mum.cs490.shoppingcart.mock.transaction.api.dao.TransactionDAO.getLastActiveTransaction(..))&& args(srcCardNo)")
